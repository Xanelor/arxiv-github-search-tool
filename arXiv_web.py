...
def index():
    ...
    try:
        ...
        return render_template_string(HTML_TEMPLATE, feed=feed, query=query, searched=bool(query))
    
    except RequestException as e:
        return render_template_string(HTML_TEMPLATE, feed=None, query=query, error=str(e), searched=False)
